...
<?php
	function asset($filename)
	{
		...
		$root 		= 'https://archive.smarchal.com/v6/';
...
<html lang="en">
	...
	<body>
		<section id="wrapper" class="wrapper closed">
			...
			<a id="zessx" class="zessx" href="https://zes.sx">zessx</a>
			<div id="strip" class="strip">
				<a href="https://www.facebook.com/marchal.samuel" class="external"><i class="icon-facebook"></i></a>
				<a href="https://fr.viadeo.com/fr/profile/samuel.marchal2" class="external"><i class="icon-viadeo"></i></a>
				<a href="https://www.linkedin.com/pub/samuel-marchal/26/a73/584" class="external"><i class="icon-linkedin"></i></a>
				<a href="https://careers.stackoverflow.com/zessx" class="external"><i class="icon-careers"></i></a>
				<a href="mailto:contact@zes.sx"><i class="icon-email"></i></a>
				<span class="separator"></span>
				<a href="https://blog.smarchal.com" class="external"><i class="icon-rss"></i></a>
				...
				<a href="https://stackoverflow.com/users/1238019/zessx" class="external"><i class="icon-stackoverflow"></i></a>
			</div>
			<div class="shutter shutter-bottom">
				<p>
					<strong>Samuel Marchal</strong><small> - zessx</small><br>
					Web Developer - <a href="https://www.alancia.fr/" class="external">Alancia</a>
				</p>
			</div>
		</section>
